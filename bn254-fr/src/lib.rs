...
mod tests {
    ...
    fn test_bn254fr() {
        ...
        let f_r_minus_1_serialized = serde_json_core::to_string(&f_r_minus_1).unwrap();
        let f_r_minus_1_deserialized: F = serde_json_core::from_str(&f_r_minus_1_serialized).unwrap();
        assert_eq!(f_r_minus_1, f_r_minus_1_deserialized);

        let f_r_minus_2_serialized = serde_json_core::to_string(&f_r_minus_2).unwrap();
        let f_r_minus_2_deserialized: F = serde_json_core::from_str(&f_r_minus_2_serialized).unwrap();
